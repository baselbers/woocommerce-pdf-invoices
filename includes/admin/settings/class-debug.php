	...
	private function get_fields() {
		$settings = array(
			array(
				...
				'section'  => 'general',
				'type'     => 'checkbox',
				'label'    => __( 'Enable debugging', 'woocommerce-pdf-invoices' ),
				'desc'     => __( 'Enable when developing a custom template or when having trouble generating a document.', 'woocommerce-pdf-invoices' ),
