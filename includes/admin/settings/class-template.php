	...
	private function get_fields() {
		...
		$settings = array(
			...
			array(
				...
				'desc'     => __( 'Customers shipping address won\'t be visible when order has only virtual products.', 'woocommerce-pdf-invoices' ),
				'default'  => 1,
				'priority' => 2,
			),
			array(
			...
			array(
				...
				'desc'     => __( 'Automatically reset invoice numbers on new year\'s day.', 'woocommerce-pdf-invoices' ) . '<br>' . __( '<b>Note</b>: You will have to generate all invoices again when changing option.', 'woocommerce-pdf-invoices' ),
				'default'  => 1,
				'priority' => 7,
			),
		);
