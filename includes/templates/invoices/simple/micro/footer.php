...
<table class="foot border" style="border-top: 4px solid <?php echo ( $is_theme_text_black ) ? 'black' : $theme_color; ?>;">
	<tr>
		<td class="company-details">
			<p><?php echo nl2br( BEWPI()->templater()->get_option( 'bewpi_left_footer_column', $this->order->id ) ); ?></p>
		</td>
		<td class="payment">
			<p><?php echo nl2br( BEWPI()->templater()->get_option( 'bewpi_right_footer_column', $this->order->id ) ); ?></p>
