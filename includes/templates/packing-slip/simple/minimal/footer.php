 ...
 *
 * This template can be overridden by copying it to youruploadsfolder/woocommerce-pdf-invoices/templates/packing-slips/simple/yourtemplatename/footer.php.
 *
